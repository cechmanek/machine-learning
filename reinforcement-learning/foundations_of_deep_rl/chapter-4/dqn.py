# implementation of DQN algorithm, using Boltzman exploration rather than epsilon-greedy
# from "Foundations of Deep Reinforcement Learning", see page 90
...
def train(dqn, optimizer):
    ...
    #target_q_values = reward + GAMMA * max(dqn(next_state)) * (not done) # aka labels for q network
